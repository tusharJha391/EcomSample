package com.allandroidprojects.sampleecomapp.ibmwatson;
            ...
            public void run() {
                try {
                    if (watsonAssistantSession == null) {
                        ServiceCall<SessionResponse> call = watsonAssistant.createSession(new CreateSessionOptions.Builder().assistantId("0e51d177-0617-4126-8720-fffe6464e762").build());
                    ...
                    MessageOptions options = new MessageOptions.Builder()
                            ...
                            .assistantId("0e51d177-0617-4126-8720-fffe6464e762")
                            .input(input)
