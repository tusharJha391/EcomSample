...
public class MicConfiguration extends LibreActivity implements RecognitionListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Load data
		ckOfflineSpeech.setChecked(MainActivityBotLIbre.offlineSpeech);
		...
		ckOfflineSpeech.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				SharedPreferences.Editor cookies = MainActivityBotLIbre.current.getPreferences(MODE_PRIVATE).edit();
				if (isChecked) {
					MainActivityBotLIbre.offlineSpeech = true;
					cookies.putBoolean("offlineSpeech", true);
					cookies.commit();
					return;
				}
				//else
				MainActivityBotLIbre.offlineSpeech = false;
	...
	public void select(View v) {
		if (spinOption.getSelectedItem().equals("Hands Free")) {
			MainActivityBotLIbre.handsFreeSpeech = true;
			...
			MainActivityBotLIbre.handsFreeSpeech = false;
			SharedPreferences.Editor cookies = MainActivityBotLIbre.current.getPreferences(Context.MODE_PRIVATE).edit();
	    	cookies.putBoolean("handsfreespeech", MainActivityBotLIbre.handsFreeSpeech);
	    	cookies.commit();
		}
