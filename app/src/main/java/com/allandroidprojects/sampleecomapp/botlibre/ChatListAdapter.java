...
public class ChatListAdapter extends ArrayAdapter<Object> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message instanceof ChatConfig) {
            ...
            if (MainActivityBotLIbre.user != null && MainActivityBotLIbre.user.avatar != null) {
            	HttpGetImageAction.fetchImage(this.activity, MainActivityBotLIbre.user.avatar, holder.userView);
            } else {
