...
import com.allandroidprojects.sampleecomapp.actions.HttpUpdateUserAction;
...
public class EditUserActivity extends CreateUserActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        UserConfig user = MainActivityBotLIbre.user;
    ...
    public void save(View view) {
    	...
    	config.user = MainActivityBotLIbre.connection.getUser().user;
