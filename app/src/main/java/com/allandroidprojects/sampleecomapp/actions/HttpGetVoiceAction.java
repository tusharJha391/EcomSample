...
public class HttpGetVoiceAction extends HttpAction {
	...
	protected String doInBackground(Void... params) {
		try {
		this.voice = MainActivityBotLIbre.connection.getVoice(this.config);
	...
	public void onPostExecute(String xml) {
		...
		try {
			if (!MainActivityBotLIbre.customVoice) {
				MainActivityBotLIbre.voice = this.voice;
				MainActivityBotLIbre.deviceVoice = this.voice.nativeVoice;
