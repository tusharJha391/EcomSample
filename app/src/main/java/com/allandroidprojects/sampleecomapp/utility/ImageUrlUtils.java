package com.allandroidprojects.sampleecomapp.utility;
...
public class ImageUrlUtils {
    ...
    public static String[] getOffersUrls() {
        String[] urls = new String[]{
                ...
                "https://static.pexels.com/photos/186035/pexels-photo-186035-medium.jpeg",
                //"https://static.pexels.com/photos/211048/pexels-photo-211048-medium.jpeg",
                "https://cdn.pixabay.com/photo/2015/09/23/03/07/menswear-952836_640.jpg",
                ...
                "https://cdn.pixabay.com/photo/2017/11/02/14/26/straight-looking-2911327_640.jpg",
    ...
    public static String[] getHomeApplianceUrls() {
        String[] urls = new String[]{
                //"https://static.pexels.com/photos/1778/numbers-time-watch-white-medium.jpg",
                "https://cdn.pixabay.com/photo/2016/01/28/22/07/washing-machine-1167053_640.jpg",
                ...
                "https://cdn.pixabay.com/photo/2018/03/08/14/57/clothing-3208822_640.jpg",
    ...
    public static String[] getElectronicsUrls() {
        String[] urls = new String[]{
                ...
                "https://cdn.pixabay.com/photo/2016/11/29/03/42/audio-1867121_640.jpg",
                //"https://static.pexels.com/photos/214487/pexels-photo-214487-medium.jpeg",
                "https://cdn.pixabay.com/photo/2014/08/29/14/53/photo-431119_640.jpg",
                //"https://static.pexels.com/photos/168575/pexels-photo-168575-medium.jpeg",
                "https://cdn.pixabay.com/photo/2016/03/05/18/19/electronic-tablet-1238205_640.jpg",
                //"https://static.pexels.com/photos/213384/pexels-photo-213384-medium.jpeg",
    ...
    public static String[] getLifeStyleUrls() {
        String[] urls = new String[]{
                ...
                "https://cdn.pixabay.com/photo/2016/10/16/23/34/fashion-show-1746599_640.jpg",
                //"https://static.pexels.com/photos/160826/girl-dress-bounce-nature-160826-medium.jpeg",
                "https://cdn.pixabay.com/photo/2016/10/21/21/12/shari-1759212_640.jpg",
                //"https://static.pexels.com/photos/1702/bow-tie-businessman-fashion-man-medium.jpg",
                "https://cdn.pixabay.com/photo/2017/08/17/08/20/online-shopping-2650383_640.jpg",
                //"https://static.pexels.com/photos/35188/child-childrens-baby-children-s-medium.jpg",
                "https://cdn.pixabay.com/photo/2016/02/25/20/41/sweater-1222876_640.jpg",
    ...
    public static String[] getItemOfferName() {
        String[] name = new String[] {
                "Leather Shoe","Men Belt","Watch","Jackets","Home Decorations","Gadgets","Tablets","Books","Stationery items","Musical instruments","Men's Wear"
    ...
    public static String[] getOfferDescription() {
        String[] name = new String[]{
            "Men Brown shoe", "Genuine leather", "Men formal watch", "Black Leather jackets", "Home Decor", "DSLR Camera"
                    , "High performance", "Fiction Myths", "Essential items", "Keyboard, Guitar", "Latest Fashion", "Best of Home decor",
                    "Small furniture", "Home needs"
        };
        return name;
    }
    public static String[] getOfferPrice() {
        String[] name = new String[] {
                "3999","1099","5999","4999","2999","21999","8999","99","599","3011","1236"
                ,"8999","7999","2999"
    ...
    // Methods for Cartkennekgne jwbfwf ₹₹
